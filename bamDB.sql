...
("Settlers of Catan", "Board Games", 39.88, 10),
("Small World", "Board Games", 36.93, 4),
("Exploding Kittens NSFW", "Card Games", 19.99, 4),
("Joking Hazard", "Card Games", 25.00, 2),
("Ticket to Ride", "Board Games", 29.99, 3),
